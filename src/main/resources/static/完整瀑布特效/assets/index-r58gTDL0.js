...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vo(e,t,n){let r=new Float32Array(ro),i=new K(0,1,0);return new Oi({name:`SphericalGaussianBlur`,defines:{n:ro,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:xo(),fragmentShader:`
	...
	`}var So=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new fi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},hm=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},gm=new sa(-1,1,1,-1,0,1),_m=new class extends wr{constructor(){super(),this.setAttribute(`position`,new fr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new fr([0,2,0,0,2,0],2))}},vm=class{constructor(e){this._mesh=new qr(_m,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,gm)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},ym=class extends hm{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Oi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ti.clone(e.uniforms),this.material=new Oi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new vm(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},bm=class extends hm{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},xm=class extends hm{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},Sm=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new G);this._width=n.width,this._height=n.height,t=new Wt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:g}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new ym(mm),this.copyPass.material.blending=0,this.timer=new ha}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}bm!==void 0&&(r instanceof bm?n=!0:r instanceof xm&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new G);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Cm=class extends hm{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Y}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},wm={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Y(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Tm.BlurDirectionX=new G(1,0),Tm.BlurDirectionY=new G(0,1);var Em=new Sa,Dm=new ua,Om=new Oa(Em),km=new Ca(Em),Am=new Ca(Em),jm=Em.context.createBiquadFilter();jm.type=`lowpass`,jm.frequency.value=22e3;var Mm=!1,Nm=!1,Pm,Fm,Im,Lm,Rm,zm,Bm,Vm=[new Y(`#E0F7FA`),new Y(`#B2EBF2`),new Y(`#81D4FA`),new Y(`#4FC3F7`),new Y(`#29B6F6`),new Y(`#0288D1`),new Y(`#01579B`),new Y(`#0D47A1`)];function Hm(){Pm=new An,Pm.background=new Y(328965);let e=window.innerWidth/window.innerHeight;Fm=new sa(-10*e,10*e,10,-10,.1,1e3),Fm.position.z=10,Bm=new Va,Um(),Wm(),Gm()}function Um(){let e=new bi(30,20);Im=new Oi({uniforms:{uTime:{value:0},uResolution:{value:new G(window.innerWidth,window.innerHeight)}},vertexShader:`
            varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `});let t=new qr(e,Im);t.position.z=-1,Pm.add(t);for(let e=0;e<12;e++){let e=new qr(new vi(Math.random()*2+1,6),new Fr({color:657932,transparent:!0,opacity:.8}));e.position.set((Math.random()-.5)*20,(Math.random()-.5)*15,-.5),e.rotation.z=Math.random()*Math.PI,Pm.add(e)}}function Wm(){let e=new bi(6,16);Lm=new Oi({uniforms:{uTime:{value:0},uColors:{value:Vm},uResolution:{value:new G(6,16)}},vertexShader:`
            varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `,transparent:!0});let t=new qr(e,Lm);t.position.y=1,Pm.add(t)}function Gm(){let e=new vi(.2,5);Rm=new Sn;for(let t=0;t<60;t++){let t=new qr(e,new Fr({color:Vm[Math.floor(Math.random()*4)],transparent:!0,opacity:.8}));Km(t),t.userData.life=Math.random(),Rm.add(t)}Rm.position.y=-7.5,Pm.add(Rm);let t=new bi(10,3);zm=new Oi({uniforms:{uTime:{value:0},uColor:{value:Vm[1]}},vertexShader:`
            varying vec2 vUv;
            void main() {
                vUv = uv;
                gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
        ...
        `,transparent:!0});let n=new qr(t,zm);n.position.y=-7.5,n.position.z=.1,Pm.add(n)}function Km(e){e.position.x=(Math.random()-.5)*6.5,e.position.y=(Math.random()-.5)*1,e.userData.velocity=new G((Math.random()-.5)*.15,Math.random()*.25+.15),e.userData.life=1,e.scale.setScalar(Math.random()*.8+.4)}function qm(e){Rm&&(Rm.children.forEach(t=>{t.position.x+=t.userData.velocity.x,t.position.y+=t.userData.velocity.y,t.userData.velocity.y-=.012,t.userData.velocity.x*=.98,t.userData.life-=e*1.2,t.material.opacity=t.userData.life,t.rotation.z+=e*5,t.userData.life<=0&&Km(t)}),zm&&(zm.uniforms.uTime.value+=e))}function Jm(e){let t=document.createElement(`div`);t.style.position=`fixed`,t.style.top=0,t.style.left=0,t.style.width=`100%`,t.style.height=`100%`,t.style.backgroundColor=`white`,t.style.pointerEvents=`none`,t.style.zIndex=9999,t.style.opacity=0,t.style.transition=`opacity 0.3s ease-out`,document.body.appendChild(t),t.style.opacity=1,setTimeout(()=>{t.style.opacity=0,setTimeout(()=>{t.remove(),e&&e()},300)},200)}function Ym(){Mm=!0,km.isPlaying&&km.stop(),Om.buffer&&!Om.isPlaying&&Om.play(),Qm.position.z=50,gh=0,Am.buffer&&!Am.isPlaying&&Am.play()}function Xm(){window.addEventListener(`click`,e=>{!Mm&&!Nm&&(Nm=!0,pm.to(Fm,{left:Fm.left*.3,right:Fm.right*.3,top:Fm.top*.3,bottom:Fm.bottom*.3,duration:.4,ease:`power2.in`,onUpdate:()=>{Fm.updateProjectionMatrix()},onComplete:()=>{Jm(()=>{Ym(),Jm(()=>{})})}}))})}var Zm=new An;Zm.background=new Y(1290);var Qm=new oa(75,window.innerWidth/window.innerHeight,.1,1e3);Qm.add(Em);var $m=new al({antialias:!0});$m.setSize(window.innerWidth,window.innerHeight),$m.setPixelRatio(Math.min(window.devicePixelRatio,2)),document.body.appendChild($m.domElement),Hm();function eh(){let t=document.createElement(`canvas`);t.width=512,t.height=1024;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,t.height);r.addColorStop(0,`#0066ff`),r.addColorStop(.5,`#002288`),r.addColorStop(1,`#0066ff`),n.fillStyle=r,n.fillRect(0,0,t.width,t.height);for(let e=0;e<800;e++){n.fillStyle=`rgba(150, 200, 255, ${Math.random()*.25})`,n.beginPath();let e=Math.random()*t.width,r=Math.random()*t.height;n.ellipse(e,r,Math.random()*2+1,Math.random()*40+10,0,0,Math.PI*2),n.fill()}let i=new pi(t);return i.wrapS=i.wrapT=e,i}var th=eh(),nh=new qr(new yi(5,5,300,32,1,!0),new Fr({map:th,side:1,transparent:!0,opacity:.9,blending:2}));nh.rotation.x=Math.PI/2,Zm.add(nh);var rh=new vi(5,32),ih=new Fr({color:16777215,transparent:!0,opacity:1,blending:2}),ah=new qr(rh,ih);ah.position.z=-150,Zm.add(ah),ah.add(Om);var oh=3e3,sh=new wr,ch=new Float32Array(oh*3),lh=new Float32Array(oh*3),uh=new Y;for(let e=0;e<oh;e++){let t=Math.random()*Math.PI*2,n=4.8;ch[e*3]=Math.cos(t)*n,ch[e*3+1]=Math.sin(t)*n,ch[e*3+2]=(Math.random()-.5)*300,uh.setHSL(Math.random(),1,.4),lh[e*3]=uh.r,lh[e*3+1]=uh.g,lh[e*3+2]=uh.b}sh.setAttribute(`position`,new lr(ch,3)),sh.setAttribute(`color`,new lr(lh,3));var dh=new ui(sh,new ai({vertexColors:!0,size:.08,transparent:!0,opacity:.8,blending:2,depthWrite:!1}));Zm.add(dh),Dm.load(`/audio/waterfall_loop(outside).mp3`,e=>{km.setBuffer(e),km.setLoop(!0),km.setVolume(.6)}),Dm.load(`/audio/waterfall_loop.mp3`,e=>{Om.setBuffer(e),Om.setLoop(!0),Om.setRefDistance(10),Om.setMaxDistance(200),Om.setRolloffFactor(2),Om.setVolume(.5),Om.setFilter(jm)}),Dm.load(`/audio/teleport_splash.mp3`,e=>{Am.setBuffer(e),Am.setVolume(.6)});var fh=()=>{Em.context.state===`suspended`&&Em.context.resume(),km.buffer&&!km.isPlaying&&km.play(),window.removeEventListener(`wheel`,fh),window.removeEventListener(`mousedown`,fh)};window.addEventListener(`wheel`,fh),window.addEventListener(`mousedown`,fh);var ph=new Sm($m);ph.addPass(new Cm(Zm,Qm));var mh=new Tm(new G(window.innerWidth,window.innerHeight),1,.4,.9);ph.addPass(mh);var hh=new ym({uniforms:{tDiffuse:{value:null},strength:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `});ph.addPass(hh);var gh=0;Qm.position.z=50,window.addEventListener(`wheel`,e=>{if(!Mm)return;gh+=e.deltaY*.05;let t=wt.clamp(50-gh,-145,100);pm.to(Qm.position,{z:t,duration:2,ease:`power2.out`,onUpdate:()=>{let e=Math.abs(Qm.position.z-ah.position.z),t=wt.clamp(1-e/200,0,1);if(t>.6){let e=wt.mapLinear(t,.6,.99,0,.12);hh.uniforms.strength.value=wt.clamp(e,0,.12),mh.strength=1+((t-.6)*6)**2}else hh.uniforms.strength.value=0,mh.strength=1;if(Om.isPlaying&&t<.99){if(t>.75){let e=wt.mapLinear(t,.75,.99,22e3,200),n=wt.clamp(e,200,22e3);jm.frequency.setValueAtTime(n,Em.context.currentTime)}else jm.frequency.setValueAtTime(22e3,Em.context.currentTime);let e=wt.lerp(.5,1.5,t);Om.setVolume(e)}if(t>=.9&&t<.99&&(Am.isPlaying||Am.play()),t>=.99){Om.isPlaying&&Om.stop(),Am.isPlaying&&Am.stop(),ih.opacity=1;let e=wt.mapLinear(t,.99,1,5,15);ih.color.setRGB(e,e,e)}}});let n=dh.geometry.attributes.color;for(let e=0;e<oh;e++){uh.fromArray(n.array,e*3);let t={h:0,s:0,l:0};uh.getHSL(t),t.h+=.01,uh.setHSL(t.h%1,t.s,t.l),uh.toArray(n.array,e*3)}n.needsUpdate=!0});function _h(){if(requestAnimationFrame(_h),Mm){th.offset.y+=.01;let e=dh.geometry.attributes.position.array;for(let t=0;t<oh;t++)e[t*3+2]+=1,e[t*3+2]>Qm.position.z+10&&(e[t*3+2]=Qm.position.z-200);dh.geometry.attributes.position.needsUpdate=!0,ph.render()}else{let e=Bm.getDelta(),t=Bm.getElapsedTime();Lm&&(Lm.uniforms.uTime.value=t),Im&&(Im.uniforms.uTime.value=t),qm(e),$m.render(Pm,Fm)}}_h(),window.addEventListener(`resize`,()=>{if(Qm.aspect=window.innerWidth/window.innerHeight,Qm.updateProjectionMatrix(),$m.setSize(window.innerWidth,window.innerHeight),ph.setSize(window.innerWidth,window.innerHeight),Fm){let e=window.innerWidth/window.innerHeight;Fm.left=-10*e,Fm.right=10*e,Fm.top=10,Fm.bottom=-10,Fm.updateProjectionMatrix()}}),Xm();